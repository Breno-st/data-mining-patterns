...
def task4(database_file_name_pos, database_file_name_neg, k, minsup, nfolds):
    """
    Uses the patterns found to train a Gradient Boosting classifier using Scikit-learn and evaluates its performances on
    the test set.
    """
...
def train_and_evaluate(minsup, database, subsets, k):
    ...
    classifier = ensemble.GradientBoostingClassifier()  # Creating model object
...
#     task4(database_file_name_pos, database_file_name_neg, k, nfolds)
...
if __name__ == '__main__':
    ...
    task4(database_file_name_pos, database_file_name_neg, k, minsup, nfolds)
